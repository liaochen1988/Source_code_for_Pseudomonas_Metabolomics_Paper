...
target_path = '../data/growth_curve_normalized/';

%% files to read
filenames = {'061020SuccinateGrowthCurve_Hildi.csv';...
             '061020SuccinateGrowthCurve_Maurice.csv';...
             '031320SuccinateGrowthCurve_Maurice.csv';...
             '061720SuccinateGrowthCurve_Hildi.csv';...
             '061720SuccinateGrowthCurve_Maurice.csv'};
nfiles = length(filenames);

%% strains for columns of 96-well plate
strains = {'Blank','PA14','M37351','M55212','M74707','T38079','T52373','T6313','T63266','W36662','Water','Empty';...
           'Blank','PA14','F23197','F5677','F9670','F63912','H27930','H47921','H5708','M1608','Water','Empty';...
           'Blank','PA14','F22031','F30658','F34365','W16407','X9820','Water','Empty','Empty','Empty','Empty';...
           'Blank','PA14','X78812','Water','Empty','Empty','Empty','Empty','Empty','Empty','Empty','Empty';...
           'Blank','PA14','PA7','PAO1','M6075','S86968','W25637','W45909','W60856','W70332','W91453','Water'};
         
%% remove backrgound noise
index_of_background_column = [11, 11, 8, 4, 12];
...
%% Write to file
writetable(tbl_gc_all, strcat(target_path, 'normalized_mean_growth_curve_PA_succinate.csv'), 'Delimiter', ',', 'WriteRowNames',true);